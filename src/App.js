		...
		return (
			<div className="App">
				...
				<Switch>
					...
					<Route exact path="/ManagerHome/employeeAll" render={() => <ManagerEmployeeAll loggedIn={this.state.loggedIn} />} />
          <Route exact path="/ManagerHome/schedulesCreate" render={() => <ManagerSchedulesCreate loggedIn={this.state.loggedIn} />} />
