		...
		return (
			<div className="App">
				...
				<Switch>
					...
					<Route exact path="/employeeAll" render={() => <ManagerEmployeeAll loggedIn={this.state.loggedIn} />} />
          <Route exact path="/schedulesCreate" render={() => <ManagerSchedulesCreate loggedIn={this.state.loggedIn} />} />
